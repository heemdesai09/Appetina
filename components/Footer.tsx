...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-maroon-950 to-maroon-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-300 font-body leading-relaxed mb-6">
              Celebrating life's special moments with exceptional service, exquisite cuisine, and elegant venues.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-xl font-display font-bold text-gold-400 mb-6">
              Quick Links
            </h4>
            <ul className="space-y-3 font-sans">
              ...
              <li>
                <a href="#menu" className="text-gray-300 hover:text-gold-400 transition-colors">
                  Menu
                </a>
              </li>
              <li>
                <a href="#gallery" className="text-gray-300 hover:text-gold-400 transition-colors">
                  Gallery
                </a>
              </li>
            </ul>
            ...
            <ul className="space-y-3 font-sans text-gray-300">
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm leading-relaxed">
                  Aastha-99, Near CTM, Amraiwadi, Ahmedabad, Gujarat 380026
                </span>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+919979448440" className="hover:text-gold-400 transition-colors">
                  +91 99794 48440
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 font-sans text-sm text-center md:text-left">
            © {currentYear} Appetina The Banquet & Restaurant. All rights reserved.
          </p>
      ...
      <a
        href="https://wa.me/919979448440"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-2xl hover:bg-green-600 transition-all duration-300 hover:scale-110 z-50"
